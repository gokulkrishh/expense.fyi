...
export default function Signup() {
	...
	return (
		<>
			...
			<main
				className={`font-default relative m-auto flex h-full w-full flex-col items-center justify-center bg-gradient-to-br from-orange-100 via-white to-orange-50`}
			>
