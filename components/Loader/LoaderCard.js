			...
			{Array(nums)
				...
				.map((num, index) => (
					...
					>
						...
						<h3 className="animate-pulse bg-gray-200 text-sm font-medium leading-6 text-slate-600">
							<span className="invisible">Loading</span>
						</h3>
						<p className="mt-1 w-[80%] animate-pulse bg-gray-200 text-xl font-semibold text-black xs:text-xl lg:text-xl xl:text-2xl">
