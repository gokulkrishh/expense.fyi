...
const Footer = () => {
	return (
		<footer className="flex h-14 w-full items-center border-t pl-6 pr-6 font-medium">
			<div className="xs:mb-0 mb-[8px] flex w-full justify-center">
				<div className="flex flex-row items-center justify-between gap-6 border-t border-white/5">
					...
					<div className="flex gap-3">
						<Link className="group" href={urls.twitter}>
						...
						<Link className="group" href={urls.github}>
