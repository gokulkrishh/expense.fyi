...
export default function Logo({ theme = 'dark', w = '28', h = '28' }) {
	return (
		<>
			{theme === 'white' ? (
				<Image src={SvgLogoWhite} className="mr-2" width={w} height={h} alt="Expense.fyi logo" />
			) : (
				<Image src={SvgLogoBlack} className="mr-2" width={w} height={h} alt="Expense.fyi logo" />
			)}
